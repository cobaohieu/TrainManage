...
*/
--11
insert into tblSinhVien values('10','2','SV1',N'Phạm Thị J','1992',N'Nữ',N'Cần Thơ',N'Cần Thơ')
insert into tblSinhVien values('11','2','SV2',N'Lê Văn L','1993',N'Nam',N'Bạc Liêu',N'Bạc Liêu')
insert into tblSinhVien values('12','2','SV3',N'Huỳnh Tấn O','1991',N'Nam',N'Hậu Giang',N'Hậu Giang')
insert into tblSinhVien values('13','2','SV4',N'Vũ Lại Y','1993',N'Nữ',N'Kiên Giang',N'Kiên Giang')
insert into tblSinhVien values('17','2','SV5',N'Dương Chí Q','1994',N'Nam',N'Tiền Giang',N'Tiền Giang')
insert into tblSinhVien values('18','2','SV6',N'Lý Chí X','1995',N'Nam',N'An Giang',N'An Giang')
insert into tblSinhVien values('10','2','SV7',N'Ngô Tùng M','1995',N'Nam',N'Cà Mau',N'Cà Mau')
insert into tblSinhVien values('15','2','SV8',N'Hồ Quý S','1990',N'Nữ',N'Vĩnh Long',N'Vĩnh Long')
insert into tblSinhVien values('12','2','SV9',N'Đặng Bá N','1990',N'Nam',N'Cần Thơ',N'Cần Thơ')
insert into tblSinhVien values('16','2','SV10',N'Hoàng Kim P','1990',N'Nữ',N'Đồng Tháp',N'Đồng Tháp')
--select * from tblSinhVien
--DBCC CHECKIDENT (tblSinhVien, RESEED, 0);
--GO
--12
insert into tblKetQua values('101','1','7.2','7','0','2.9','Tốt','')
insert into tblKetQua values('102','2','8.3','8','0','3.0','Tốt','')
insert into tblKetQua values('103','3','7.5','9','0','2.5','Tốt','')
insert into tblKetQua values('104','4','7.7','10','0','3.1','Tốt','')
insert into tblKetQua values('105','5','6.9','6','0','2.8','Tốt','')
insert into tblKetQua values('106','6','5.3','7','0','2.7','Tốt','')
insert into tblKetQua values('107','8','5.6','5','0','2.0','Khá','')
insert into tblKetQua values('108','9','8.9','6','0','2.6','Tốt','')
insert into tblKetQua values('109','7','9.2','3','8','1.8','Khá','')
insert into tblKetQua values('110','6','10','3','7','1.5','Khá','')
--13
insert into tblTaiKhoan values('gv1',N'12345678',N'Giáo viên',N'Giang','1993',N'Nữ',N'Tiền Giang',N'Tiền Giang')
insert into tblTaiKhoan values('gv2',N'12345678',N'Giáo viên',N'Phát','1994',N'Nam',N'Cần Thơ',N'Cần Thơ')
insert into tblTaiKhoan values('gv3',N'12345678',N'Giáo viên',N'Hiếu','1994',N'Nam',N'Cà Mau',N'Cà Mau')
insert into tblTaiKhoan values('qt1',N'12345678',N'Quản trị viên',N'Khoa','1994',N'Nam',N'An Giang',N'An Giang')
insert into tblTaiKhoan values('qt2',N'12345678',N'Quản trị viên',N'Tâm','1983',N'Nam',N'Kiên Giang',N'Kiên Giang')
insert into tblTaiKhoan values('qt3',N'12345678',N'Quản trị viên',N'Thiên','1993',N'Nam',N'Hậu Giang',N'Hậu Giang')
insert into tblTaiKhoan values('ql1',N'12345678',N'Quản lý chương trình đào tạo viên',N'Khánh','1990',N'Nữ',N'Vĩnh Long',N'Vĩnh Long')
insert into tblTaiKhoan values('ql2',N'12345678',N'Quản lý chương trình đào tạo viên',N'Cường','1991',N'Nam',N'Bạc Liêu',N'Bạc Liêu')
insert into tblTaiKhoan values('qt',N'12345678',N'Quản trị viên',N'Hưng','1992',N'Nam',N'Sóc Trăng',N'Sóc Trăng')
insert into tblTaiKhoan values('gv',N'12345678',N'Giáo viên',N'Hùng','1985',N'Nam',N'Bến Tre',N'Bến Tre')
insert into tblTaiKhoan values('ql',N'12345678',N'Quán lý chương trình đào tạo viên',N'Hoàng','1988',N'Nữ',N'Đồng Tháp',N'Đồng Tháp')
