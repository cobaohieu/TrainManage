...
as
begin
	select tentaikhoan, matkhau, quyen from tblTaiKhoan
...
as
begin
	select ttk.tentaikhoan, ttk.matkhau, ttk.nhom, ttk.hoten, ttk.namsinh, ttk.gioitinh, ttk.noisinh, ttk.diachi from tblThongTin as ttt
end
go
--
...
as
begin
	select ttk.tentaikhoan, ttk.matkhau, ttk.nhom, ttk.hoten, ttk.namsinh, ttk.gioitinh, ttk.noisinh, ttk.diachi from tblThongTin as ttk
	where id = @id
end
go
--
